...
export class MatchController {
  ...
  index = async (req: Request, res: Response) => {
    const result = await this._matchService.getMatches(100, 1);
  ...
  getMatch = async (req: Request, res: Response) => {
    ...
    console.log(id);
    const result = await this._matchService.getMatchById(id);
  ...
  createMatch = async (req: Request, res: Response) => {
    ...
    console.log(match);
    const result = await this._matchService.addMatch(match);
    res.send(result);
  };
  ...
  setMatchStarted = async (req: Request, res: Response) => {
    ...
    const result = await this._matchService.setMatchStarted(id, false);
